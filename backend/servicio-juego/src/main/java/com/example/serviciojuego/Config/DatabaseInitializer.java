package com.example.serviciojuego.Config;
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    private void inicializarTrivia() {
        if (preguntaRepository.count() == 0) {
            System.out.println("---- Inicializando Trivia de Hollow Knight (10 Preguntas) ----");

            triviaService.guardarPregunta(
                    "¿Cómo se conoce comúnmente al protagonista que controla el jugador?",
                    "El Caballero",
                    Arrays.asList("El Rey Pálido", "El Caballero", "Hollow Knight", "Quirrel")
            );

            triviaService.guardarPregunta(
                    "¿Cuál es la moneda principal utilizada para comerciar en Hallownest?",
                    "Geo",
                    Arrays.asList("Almas", "Geo", "Esencia", "Reliquias")
            );

            triviaService.guardarPregunta(
                    "¿Qué personaje usa una aguja como arma y viste una capa roja?",
                    "Hornet",
                    Arrays.asList("Iselda", "Zote", "Cloth", "Hornet")
            );

            triviaService.guardarPregunta(
                    "¿Qué objeto necesitas comprar para ver tu ubicación actual en el mapa?",
                    "La Brújula Caprichosa",
                    Arrays.asList("La Pluma", "El Marcador", "La Brújula Caprichosa", "El Mapa de Coleccionista")
            );

            triviaService.guardarPregunta(
                    "¿Cuál es el nombre del cartógrafo que encuentras tarareando en diferentes áreas?",
                    "Cornifer",
                    Arrays.asList("Sly", "Lemm", "Cornifer", "Bretta")
            );

            triviaService.guardarPregunta(
                    "¿Qué habilidad obtienes en la Aldea Mantis que te permite saltar en las paredes?",
                    "Garra de Mantis",
                    Arrays.asList("Garra de Mantis", "Capa de Ala de Polilla", "Alas de Monarca", "Corazón de Cristal")
            );

            triviaService.guardarPregunta(
                    "¿Cuál es el recurso que se consume para regenerar la salud (máscaras) del Caballero?",
                    "Alma",
                    Arrays.asList("Vacío", "Alma", "Saviavida", "Infección")
            );

            triviaService.guardarPregunta(
                    "¿Cómo se llama la zona capital de Hallownest donde siempre está lloviendo?",
                    "Ciudad de Lágrimas",
                    Arrays.asList("Bocasucia", "Nido Profundo", "Ciudad de Lágrimas", "Jardines de la Reina")
            );

            triviaService.guardarPregunta(
                    "¿Quién es la fuente original de la Infección (el 'sol' en los sueños)?",
                    "El Destello",
                    Arrays.asList("El Rey Pálido", "El Hollow Knight", "Grimm", "El Destello")
            );

            triviaService.guardarPregunta(
                    "¿Cómo se llama el sistema de transporte rápido subterráneo de Hallownest?",
                    "Estaciones de Ciervo",
                    Arrays.asList("El Tranvía", "Estaciones de Ciervo", "Alas de Monarca", "Teletransportadores Oníricos")
            );

            System.out.println("---- Trivia Inicializada Correctamente (" + preguntaRepository.count() + " preguntas) ----");
        }
    }
    private void inicializarChecklist() {
        if (checklistRepository.count() == 0) {
            System.out.println("---- Inicializando Checklist en Base de Datos ----");

            List<ChecklistItemDTO> items = Arrays.asList(
                    // JEFES
                    new ChecklistItemDTO("boss1", "Falso Caballero", "boss", 1.0),
                    new ChecklistItemDTO("boss2", "Madre Gruz", "boss", 1.0),
                    new ChecklistItemDTO("boss3", "Maestro del alma", "boss", 1.0),
                    new ChecklistItemDTO("boss4", "Malwek Incubador", "boss", 1.0),
                    new ChecklistItemDTO("boss5", "Señores Mantis", "boss", 1.0),
                    new ChecklistItemDTO("boss6", "Hornet (Protectora)", "boss", 1.0),
                    new ChecklistItemDTO("boss7", "Nosk", "boss", 1.0),
                    new ChecklistItemDTO("boss8", "Caballero de la Colmena", "boss", 1.0),
                    new ChecklistItemDTO("boss9", "Defensor del Estiercol", "boss", 1.0),
                    new ChecklistItemDTO("boss10", "Hornet (Centinela)", "boss", 1.0),
                    new ChecklistItemDTO("boss11", "Señor Traidor", "boss", 1.0),
                    new ChecklistItemDTO("boss12", "Grim", "boss", 1.0),
                    new ChecklistItemDTO("boss13", "Coleccionista", "boss", 1.0),
                    new ChecklistItemDTO("boss14", "Uumuu", "boss", 1.0),
                    new ChecklistItemDTO("boss15", "Caballeros Vigilantes", "boss", 1.0),
                    new ChecklistItemDTO("boss16", "Galien", "boss", 1.0),
                    new ChecklistItemDTO("boss17", "Marmu", "boss", 1.0),
                    new ChecklistItemDTO("boss18", "Markoth", "boss", 1.0),
                    new ChecklistItemDTO("boss19", "Xero", "boss", 1.0),
                    new ChecklistItemDTO("boss20", "Sin Ojos", "boss", 1.0),
                    new ChecklistItemDTO("boss21", "Viejo Hu", "boss", 1.0),
                    new ChecklistItemDTO("boss22", "Gorb", "boss", 1.0),
                    new ChecklistItemDTO("boss23", "Rey Pesadilla Grimm", "boss", 1.0),

                    // EQUIPAMIENTO
                    new ChecklistItemDTO("equip1", "Capa de Polilla", "equip", 2.0),
                    new ChecklistItemDTO("equip2", "Garra de Mantis", "equip", 2.0),
                    new ChecklistItemDTO("equip3", "Corazon de Cristal", "equip", 2.0),
                    new ChecklistItemDTO("equip4", "Lagrima de Isma", "equip", 2.0),
                    new ChecklistItemDTO("equip5", "Marca del Rey", "equip", 2.0),
                    new ChecklistItemDTO("equip6", "Alas del Monarca", "equip", 2.0),
                    new ChecklistItemDTO("equip7", "Manto de la Oscuridad", "equip", 2.0),

                    // HECHIZOS
                    new ChecklistItemDTO("spell1", "Espiritu Vengativo", "spell", 1.0),
                    new ChecklistItemDTO("spell2", "Alma Sombria", "spell", 1.0),
                    new ChecklistItemDTO("spell3", "Oscuridad descendente", "spell", 1.0),
                    new ChecklistItemDTO("spell4", "Espectros Aulladores", "spell", 1.0),
                    new ChecklistItemDTO("spell5", "Chillido del Abismo", "spell", 1.0),

                    // COLISEO
                    new ChecklistItemDTO("colosseum1", "Prueba del Guerrero", "colosseum", 1.0),
                    new ChecklistItemDTO("colosseum2", "Prueba del Conquistador", "colosseum", 1.0),
                    new ChecklistItemDTO("colosseum3", "Prueba del Insensato", "colosseum", 1.0),

                    // FRAGMENTOS DE MASCARA
                    new ChecklistItemDTO("mask-shard1", "Fragmento 1", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard2", "Fragmento 2", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard3", "Fragmento 3", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard4", "Fragmento 4", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard5", "Fragmento 5", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard6", "Fragmento 6", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard7", "Fragmento 7", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard8", "Fragmento 8", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard9", "Fragmento 9", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard10", "Fragmento 10", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard11", "Fragmento 11", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard12", "Fragmento 12", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard13", "Fragmento 13", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard14", "Fragmento 14", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard15", "Fragmento 15", "mask-shard", 0.25),
                    new ChecklistItemDTO("mask-shard16", "Fragmento 16", "mask-shard", 0.25),

                    // MEJORAS DE AGUIJÓN
                    new ChecklistItemDTO("nail-upgrade1", "Aguijon Afilado", "nail-upgrade", 1.0),
                    new ChecklistItemDTO("nail-upgrade2", "Aguijon Esterilizado", "nail-upgrade", 1.0),
                    new ChecklistItemDTO("nail-upgrade3", "Aguijon en Espiral", "nail-upgrade", 1.0),
                    new ChecklistItemDTO("nail-upgrade4", "Aguijon Puro", "nail-upgrade", 1.0),

                    // NAIL DE SUEÑO
                    new ChecklistItemDTO("dream-nail1", "Consigue el Aguijon Onirico", "dream-nail", 1.0),
                    new ChecklistItemDTO("dream-nail2", "Despierta el Aguijon Onirico", "dream-nail", 1.0),
                    new ChecklistItemDTO("dream-nail3", "Ultimas palabras del Seer", "dream-nail", 1.0),

                    // ARTE DEL AGUIJON
                    new ChecklistItemDTO("nail-art1", "Gran Corte", "nail-art", 1.0),
                    new ChecklistItemDTO("nail-art2", "Corte Ciclon", "nail-art", 1.0),
                    new ChecklistItemDTO("nail-art3", "Corte Veloz", "nail-art", 1.0),

                    // FRAGMENTOS DE VASIJA
                    new ChecklistItemDTO("vessel-fragment1", "Fragmento de Vasija 1", "vessel-fragment", 0.333),
                    new ChecklistItemDTO("vessel-fragment2", "Fragmento de Vasija 2", "vessel-fragment", 0.333),
                    new ChecklistItemDTO("vessel-fragment3", "Fragmento de Vasija 3", "vessel-fragment", 0.333),
                    new ChecklistItemDTO("vessel-fragment4", "Fragmento de Vasija 4", "vessel-fragment", 0.333),
                    new ChecklistItemDTO("vessel-fragment5", "Fragmento de Vasija 5", "vessel-fragment", 0.333),
                    new ChecklistItemDTO("vessel-fragment6", "Fragmento de Vasija 6", "vessel-fragment", 0.333),
                    new ChecklistItemDTO("vessel-fragment7", "Fragmento de Vasija 7", "vessel-fragment", 0.333),
                    new ChecklistItemDTO("vessel-fragment8", "Fragmento de Vasija 8", "vessel-fragment", 0.333),
                    new ChecklistItemDTO("vessel-fragment9", "Fragmento de Vasija 9", "vessel-fragment", 0.333),

                    // SOÑADORES
                    new ChecklistItemDTO("dreamer1", "Monomon la Entendida", "dreamer", 2.0),
                    new ChecklistItemDTO("dreamer2", "Lurien el Vigia", "dreamer", 2.0),
                    new ChecklistItemDTO("dreamer3", "Herrah la Bestia", "dreamer", 2.0),

                    // HOGAR DE LOS DIOSES
                    new ChecklistItemDTO("godhome1", "Panteon del Maestro", "godhome", 1.0),
                    new ChecklistItemDTO("godhome2", "Panteon del Artista", "godhome", 1.0),
                    new ChecklistItemDTO("godhome3", "Panteon del Sabio", "godhome", 1.0),
                    new ChecklistItemDTO("godhome4", "Panteon del Caballero", "godhome", 1.0),
                    new ChecklistItemDTO("godhome5", "Panteon de Hallownest", "godhome", 1.0),

                    // AMULETOS
                    new ChecklistItemDTO("charm1", "Brujula Caprichosa", "charm", 1.0),
                    new ChecklistItemDTO("charm2", "Enjambre Recolector", "charm", 1.0),
                    new ChecklistItemDTO("charm3", "Coraza Robusta", "charm", 1.0),
                    new ChecklistItemDTO("charm4", "Atrapalmas", "charm", 1.0),
                    new ChecklistItemDTO("charm5", "Piedra de Chamán", "charm", 1.0),
                    new ChecklistItemDTO("charm6", "Devoralmas", "charm", 1.0),
                    new ChecklistItemDTO("charm7", "Maestro de la Embestida", "charm", 1.0),
                    new ChecklistItemDTO("charm8", "Maestro del Esprint", "charm", 1.0),
                    new ChecklistItemDTO("charm9", "Cancion de las Larvas", "charm", 1.0),
                    new ChecklistItemDTO("charm10", "Elegía de la Larvamosca", "charm", 1.0),
                    new ChecklistItemDTO("charm11", "Corazon Fragil", "charm", 1.0),
                    new ChecklistItemDTO("charm12", "Avaricia Fragil", "charm", 1.0),
                    new ChecklistItemDTO("charm13", "Fuerza Fragil", "charm", 1.0),
                    new ChecklistItemDTO("charm14", "TuerceHechizos", "charm", 1.0),
                    new ChecklistItemDTO("charm15", "Cuerpo Firme", "charm", 1.0),
                    new ChecklistItemDTO("charm16", "Golpe Pesado", "charm", 1.0),
                    new ChecklistItemDTO("charm17", "Corte Rápido", "charm", 1.0),
                    new ChecklistItemDTO("charm18", "Largoaguijon", "charm", 1.0),
                    new ChecklistItemDTO("charm19", "Marca del Orgullo", "charm", 1.0),
                    new ChecklistItemDTO("charm20", "Furia de los Caídos", "charm", 1.0),
                    new ChecklistItemDTO("charm21", "Espinas de Agonía", "charm", 1.0),
                    new ChecklistItemDTO("charm22", "Coraza de Baldur", "charm", 1.0),
                    new ChecklistItemDTO("charm23", "Nido de Larvas", "charm", 1.0),
                    new ChecklistItemDTO("charm24", "Blason del Defensor", "charm", 1.0),
                    new ChecklistItemDTO("charm25", "Vientre Brillante", "charm", 1.0),
                    new ChecklistItemDTO("charm26", "Concentracion Rapida", "charm", 1.0),
                    new ChecklistItemDTO("charm27", "Concentracion Profunda", "charm", 1.0),
                    new ChecklistItemDTO("charm28", "Corazón de Sangre Vital", "charm", 1.0),
                    new ChecklistItemDTO("charm29", "Alma de Sangre Vital", "charm", 1.0),
                    new ChecklistItemDTO("charm30", "Bendicion de Joni", "charm", 1.0),
                    new ChecklistItemDTO("charm31", "Sangrecolmena", "charm", 1.0),
                    new ChecklistItemDTO("charm32", "Hongo con Esporas", "charm", 1.0),
                    new ChecklistItemDTO("charm33", "Sombra Afilada", "charm", 1.0),
                    new ChecklistItemDTO("charm34", "Forma de Unn", "charm", 1.0),
                    new ChecklistItemDTO("charm35", "Gloria del Maestro de Aguijones", "charm", 1.0),
                    new ChecklistItemDTO("charm36", "Cancion de la Tejedora", "charm", 1.0),
                    new ChecklistItemDTO("charm37", "Portador Onirico", "charm", 1.0),
                    new ChecklistItemDTO("charm38", "Escudo Onirico", "charm", 1.0),
                    new ChecklistItemDTO("charm39", "Niño de Grimm / Melodia Despreocupada", "charm", 1.0),
                    new ChecklistItemDTO("charm40", "Alma del Rey / Corazón del vacio", "charm", 1.0)
            );

            for (ChecklistItemDTO item : items) {
                checklistService.crearItem(item);
            }
            System.out.println("---- Checklist Inicializada Correctamente ----");
        }
    }
    private void inicializarGuia() {
        if (guiaRepository.count() == 0) {
            System.out.println("---- Inicializando Guía en Base de Datos ----");

            List<GuiaSeccionDTO> guiaItems = Arrays.asList(
                    new GuiaSeccionDTO(
                            "0",
                            "El viaje a Bocasucia",
                            """
                                    <p>Una vez que tomes el control del Caballero, avanza hacia la derecha por el Paso del Rey, abriéndote paso a
        ...
        <p>
          Una vez derrotado el Caballero Falso, tu siguiente objetivo es aprender tu primer Hechizo.
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "Un pincel magico",
                            """
                                    <p>Después de despachar al Caballero Falso y recoger el Escudo de la Ciudad, dirígete a la izquierda y reclama
        ...
        """
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "Sendero Verde",
                            """
                                    <img src="/img/Hollow_knight_7_1.jpg" alt="Guia_7_1" class="img-fluid my-2">
        <p>
        ...
        """
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "Hornet Protectora",
                            """
                                    <h2>Derrotando a Hornet(Protectora)</h2>
        ...
        """
                    ...
                    new GuiaSeccionDTO(
                            "8",
                            "Preparacion para desechos fungicos",
                            """
                                    <p>
        ...
        """
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "Desechos Fungicos",
                            """
                                    <img src="/img/Hollow_knight_10_1.jpg" alt="Guia_10_1" class="img-fluid my-2">
        <p>
        ...
        """
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "Ciudad de Lagrimas",
                            """
                                    <h2>Como llegar a la Ciudad de Lágrimas y usar el Emblema de la Ciudad</h2>
        <p>
        ...
        """
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "Picos de Cristal",
                            """
                                    <h2>Como llegar a los Picos de Cristal</h2>
        <p>
        ...
        """
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "Nido Profundo",
                            """
                                    <h2>Como llegar al Nido Profundo</h2>
        <p>
        ...
        """
          ...
          """
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "Limites del Reino",
                            """
                                    <h2>Como conseguir las alas del monarca</h2>
        <p>
        ...
        """
                    ...
                    new GuiaSeccionDTO(
                            ...
                            "The Hollow Knight",
                            """
                                    <h2>Como derrotar al Hollow Knight</h2>
        <p>
        ...
        """
            ...
            for (GuiaSeccionDTO item : guiaItems) {
                guiaService.crearSeccion(item);
            }
            System.out.println("---- Guía Inicializada Correctamente ----");
}}}